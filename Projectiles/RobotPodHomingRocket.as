...
void onInit(CBlob@ this)
{
	...
	this.set_u8("custom_hitter", LWBRobotHitters::physical_module);
	this.Tag("exploding");
}
...
void onTick(CBlob@ this)
{
	...
	if (!this.hasTag("collided")) //we haven't hit anything yet!
	{
		...
		CBlob@ enemy = getBlobByNetworkID(this.get_netid("target"));

		if (this.getTickSinceCreated() > 30 && enemy !is null && !enemy.hasTag("dead"))
		{
...
void onCollision(CBlob@ this, CBlob@ blob, bool solid, Vec2f normal, Vec2f point1)
{
	if (blob !is null && doesCollideWithBlob(this, blob) && !this.hasTag("collided"))
	{
		...
		{
			this.Tag("collided");
			this.server_Hit(blob, point1, initVelocity, dmg, LWBRobotHitters::physical_module);
		}
